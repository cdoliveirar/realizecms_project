# Django settings for realizecms project.
import os
gettext = lambda s: s
...
SECRET_KEY = 'dscycj)^1lwh*mx+!!d31kbb0=1_5auwebtf1bxk@j1kcz@i4d'
...
ROOT_URLCONF = 'realizecms.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'realizecms.wsgi.application'
...
CMS_TEMPLATES = (
    ...
    ('template_aboutus.html', 'Template Enterprice'),
    ('template_model.html', 'Template Model'),
    ('template_courses.html', 'Template Courses'),
...
BOOTSTRAP_CAROUSEL_IMGSIZE = (960, 415)
